$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            // Event start date
            start: new Date('Apr 13, 2024 11:00'),
            ...
            end: new Date('Apr 13, 2024 15:30'),

            // Event Address
            address: '台北市中山區敬業四路168號, 維多利亞酒店',
...
// Google map
function initMap() {
    var location = {lat: 25.084378682735505, lng: 121.55898475283597};
...
function initBBSRMap() {
    var la_fiesta = {lat: 25.084378682735505, lng: 121.55898475283597};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
